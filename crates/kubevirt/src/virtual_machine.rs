...
// kopium command: kopium -f /home/mfernandez/Documents/crd-rs/crds/kubevirt/virtualmachines.kubevirt.io.yaml --schema=derived -d --hide-prelude
...
pub struct VirtualMachineTemplateSpec {
    ...
    pub utility_volumes: Option<Vec<VirtualMachineTemplateSpecUtilityVolumes>>,
...
pub struct VirtualMachineTemplateSpecDomain {
    ...
    pub reboot_policy: Option<VirtualMachineTemplateSpecDomainRebootPolicy>,
...
pub struct VirtualMachineTemplateSpecDomainDevicesInterfaces {
    ...
    pub passt_binding: Option<VirtualMachineTemplateSpecDomainDevicesInterfacesPasstBinding>,
...
pub struct VirtualMachineTemplateSpecDomainFeaturesHypervTlbflush {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub direct: Option<VirtualMachineTemplateSpecDomainFeaturesHypervTlbflushDirect>,
    /// Enabled determines if the feature should be enabled or disabled on the guest.
    /// Defaults to true.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub extended: Option<VirtualMachineTemplateSpecDomainFeaturesHypervTlbflushExtended>,
}

/// Direct allows sending the TLB flush command directly to the hypervisor.
/// It can be useful to optimize performance in nested virtualization cases, such as Windows VBS.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct VirtualMachineTemplateSpecDomainFeaturesHypervTlbflushDirect {
    /// Enabled determines if the feature should be enabled or disabled on the guest.
    /// Defaults to true.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
...
/// Extended allows the guest to execute partial TLB flushes. It can be helpful for general purpose workloads.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct VirtualMachineTemplateSpecDomainFeaturesHypervTlbflushExtended {
    /// Enabled determines if the feature should be enabled or disabled on the guest.
    /// Defaults to true.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
...
pub struct VirtualMachineTemplateSpecDomainMemory {
    ...
    pub reserved_overhead: Option<VirtualMachineTemplateSpecDomainMemoryReservedOverhead>,
}
...
/// and its characteristics.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct VirtualMachineTemplateSpecDomainMemoryReservedOverhead {
    ...
    pub mem_lock: Option<VirtualMachineTemplateSpecDomainMemoryReservedOverheadMemLock>,
}

/// ReservedOverhead configures the memory overhead applied to a VM
/// and its characteristics.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum VirtualMachineTemplateSpecDomainMemoryReservedOverheadMemLock {
    NotRequired,
    Required,
}
...
/// Specification of the desired behavior of the VirtualMachineInstance on the host.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub enum VirtualMachineTemplateSpecDomainRebootPolicy {
    Reboot,
    Terminate,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct VirtualMachineTemplateSpecUtilityVolumes {
...
pub struct VirtualMachineTemplateSpecVolumes {
    ...
    pub container_path: Option<VirtualMachineTemplateSpecVolumesContainerPath>,
...
/// The path must correspond to an existing volumeMount in the compute container.
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct VirtualMachineTemplateSpecVolumesContainerPath {
...
pub struct VirtualMachineStatusChangedBlockTracking {
    ...
    pub backup_status: Option<VirtualMachineStatusChangedBlockTrackingBackupStatus>,
...
/// BackupStatus represents the status of vmi backup
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct VirtualMachineStatusChangedBlockTrackingBackupStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub volumes: Option<Vec<VirtualMachineStatusChangedBlockTrackingBackupStatusVolumes>>,
}

/// BackupVolumeInfo contains information about a volume included in a backup
#[derive(Serialize, Deserialize, Clone, Debug, JsonSchema)]
pub struct VirtualMachineStatusChangedBlockTrackingBackupStatusVolumes {
