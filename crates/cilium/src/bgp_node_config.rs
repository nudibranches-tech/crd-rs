...
// kopium command: kopium -f crds/cilium/v2/ciliumbgpnodeconfigs.yaml --schema=derived -d --hide-prelude
...
pub struct CiliumBgpNodeConfigBgpInstancesPeersAutoDiscoveryDefaultGateway {
    ...
    pub address_family:
        CiliumBgpNodeConfigBgpInstancesPeersAutoDiscoveryDefaultGatewayAddressFamily,
}
