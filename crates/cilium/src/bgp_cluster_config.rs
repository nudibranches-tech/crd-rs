...
// kopium command: kopium -f crds/cilium/v2/ciliumbgpclusterconfigs.yaml --schema=derived -d --hide-prelude
...
pub struct CiliumBgpClusterConfigBgpInstancesPeersAutoDiscoveryDefaultGateway {
    ...
    pub address_family:
        CiliumBgpClusterConfigBgpInstancesPeersAutoDiscoveryDefaultGatewayAddressFamily,
}
