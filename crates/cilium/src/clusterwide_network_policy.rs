...
// kopium command: kopium -f /home/mmoreiradj/git/crd-rs/crds/cilium/v2/ciliumclusterwidenetworkpolicies.yaml --schema=derived -d --hide-prelude
...
pub struct CiliumClusterwideNetworkPolicyEgressToCidrSetCidrGroupSelector {
    ...
    pub match_expressions:
        Option<Vec<CiliumClusterwideNetworkPolicyEgressToCidrSetCidrGroupSelectorMatchExpressions>>,
...
pub struct CiliumClusterwideNetworkPolicyEgressToCidrSetCidrGroupSelectorMatchExpressions {
    ...
    pub operator:
        CiliumClusterwideNetworkPolicyEgressToCidrSetCidrGroupSelectorMatchExpressionsOperator,
...
pub struct CiliumClusterwideNetworkPolicyEgressDenyToCidrSet {
    ...
    pub cidr_group_selector:
        Option<CiliumClusterwideNetworkPolicyEgressDenyToCidrSetCidrGroupSelector>,
    /// ExceptCIDRs is a list of IP blocks which the endpoint subject to the rule
    /// is not allowed to initiate connections to. These CIDR prefixes should be
    /// contained within Cidr, using ExceptCIDRs together with CIDRGroupRef is not
    /// supported yet.
...
pub struct CiliumClusterwideNetworkPolicyEgressDenyToCidrSetCidrGroupSelector {
    ...
    pub match_expressions: Option<
        Vec<CiliumClusterwideNetworkPolicyEgressDenyToCidrSetCidrGroupSelectorMatchExpressions>,
    >,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
...
pub struct CiliumClusterwideNetworkPolicyEgressDenyToCidrSetCidrGroupSelectorMatchExpressions {
    ...
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
    pub operator:
        CiliumClusterwideNetworkPolicyEgressDenyToCidrSetCidrGroupSelectorMatchExpressionsOperator,
    /// values is an array of string values. If the operator is In or NotIn,
    /// the values array must be non-empty. If the operator is Exists or DoesNotExist,
    /// the values array must be empty. This array is replaced during a strategic
    /// merge patch.
...
pub struct CiliumClusterwideNetworkPolicyIngressFromCidrSet {
    ...
    pub cidr_group_selector:
        Option<CiliumClusterwideNetworkPolicyIngressFromCidrSetCidrGroupSelector>,
    /// ExceptCIDRs is a list of IP blocks which the endpoint subject to the rule
    /// is not allowed to initiate connections to. These CIDR prefixes should be
    /// contained within Cidr, using ExceptCIDRs together with CIDRGroupRef is not
    /// supported yet.
...
pub struct CiliumClusterwideNetworkPolicyIngressFromCidrSetCidrGroupSelector {
    ...
    pub match_expressions: Option<
        Vec<CiliumClusterwideNetworkPolicyIngressFromCidrSetCidrGroupSelectorMatchExpressions>,
    >,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
...
pub struct CiliumClusterwideNetworkPolicyIngressFromCidrSetCidrGroupSelectorMatchExpressions {
    ...
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
    pub operator:
        CiliumClusterwideNetworkPolicyIngressFromCidrSetCidrGroupSelectorMatchExpressionsOperator,
    /// values is an array of string values. If the operator is In or NotIn,
    /// the values array must be non-empty. If the operator is Exists or DoesNotExist,
    /// the values array must be empty. This array is replaced during a strategic
    /// merge patch.
...
pub struct CiliumClusterwideNetworkPolicyIngressDenyFromCidrSet {
    ...
    pub cidr_group_selector:
        Option<CiliumClusterwideNetworkPolicyIngressDenyFromCidrSetCidrGroupSelector>,
    /// ExceptCIDRs is a list of IP blocks which the endpoint subject to the rule
    /// is not allowed to initiate connections to. These CIDR prefixes should be
    /// contained within Cidr, using ExceptCIDRs together with CIDRGroupRef is not
    /// supported yet.
...
pub struct CiliumClusterwideNetworkPolicyIngressDenyFromCidrSetCidrGroupSelector {
    ...
    pub match_expressions: Option<
        Vec<CiliumClusterwideNetworkPolicyIngressDenyFromCidrSetCidrGroupSelectorMatchExpressions>,
    >,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
...
pub struct CiliumClusterwideNetworkPolicysEgressToCidrSet {
    ...
    pub cidr_group_selector:
        Option<CiliumClusterwideNetworkPolicysEgressToCidrSetCidrGroupSelector>,
    /// ExceptCIDRs is a list of IP blocks which the endpoint subject to the rule
    /// is not allowed to initiate connections to. These CIDR prefixes should be
    /// contained within Cidr, using ExceptCIDRs together with CIDRGroupRef is not
    /// supported yet.
...
pub struct CiliumClusterwideNetworkPolicysEgressToCidrSetCidrGroupSelector {
    ...
    pub match_expressions: Option<
        Vec<CiliumClusterwideNetworkPolicysEgressToCidrSetCidrGroupSelectorMatchExpressions>,
    >,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
...
pub struct CiliumClusterwideNetworkPolicysEgressToCidrSetCidrGroupSelectorMatchExpressions {
    ...
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
    pub operator:
        CiliumClusterwideNetworkPolicysEgressToCidrSetCidrGroupSelectorMatchExpressionsOperator,
    /// values is an array of string values. If the operator is In or NotIn,
    /// the values array must be non-empty. If the operator is Exists or DoesNotExist,
    /// the values array must be empty. This array is replaced during a strategic
    /// merge patch.
...
pub struct CiliumClusterwideNetworkPolicysEgressDenyToCidrSet {
    ...
    pub cidr_group_selector:
        Option<CiliumClusterwideNetworkPolicysEgressDenyToCidrSetCidrGroupSelector>,
    /// ExceptCIDRs is a list of IP blocks which the endpoint subject to the rule
    /// is not allowed to initiate connections to. These CIDR prefixes should be
    /// contained within Cidr, using ExceptCIDRs together with CIDRGroupRef is not
    /// supported yet.
...
pub struct CiliumClusterwideNetworkPolicysEgressDenyToCidrSetCidrGroupSelector {
    ...
    pub match_expressions: Option<
        Vec<CiliumClusterwideNetworkPolicysEgressDenyToCidrSetCidrGroupSelectorMatchExpressions>,
    >,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
...
pub struct CiliumClusterwideNetworkPolicysEgressDenyToCidrSetCidrGroupSelectorMatchExpressions {
    ...
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
    pub operator:
        CiliumClusterwideNetworkPolicysEgressDenyToCidrSetCidrGroupSelectorMatchExpressionsOperator,
    /// values is an array of string values. If the operator is In or NotIn,
    /// the values array must be non-empty. If the operator is Exists or DoesNotExist,
    /// the values array must be empty. This array is replaced during a strategic
    /// merge patch.
...
pub struct CiliumClusterwideNetworkPolicysIngressFromCidrSet {
    ...
    pub cidr_group_selector:
        Option<CiliumClusterwideNetworkPolicysIngressFromCidrSetCidrGroupSelector>,
    /// ExceptCIDRs is a list of IP blocks which the endpoint subject to the rule
    /// is not allowed to initiate connections to. These CIDR prefixes should be
    /// contained within Cidr, using ExceptCIDRs together with CIDRGroupRef is not
    /// supported yet.
...
pub struct CiliumClusterwideNetworkPolicysIngressFromCidrSetCidrGroupSelector {
    ...
    pub match_expressions: Option<
        Vec<CiliumClusterwideNetworkPolicysIngressFromCidrSetCidrGroupSelectorMatchExpressions>,
    >,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
...
pub struct CiliumClusterwideNetworkPolicysIngressFromCidrSetCidrGroupSelectorMatchExpressions {
    ...
    /// Valid operators are In, NotIn, Exists and DoesNotExist.
    pub operator:
        CiliumClusterwideNetworkPolicysIngressFromCidrSetCidrGroupSelectorMatchExpressionsOperator,
    /// values is an array of string values. If the operator is In or NotIn,
    /// the values array must be non-empty. If the operator is Exists or DoesNotExist,
    /// the values array must be empty. This array is replaced during a strategic
    /// merge patch.
...
pub struct CiliumClusterwideNetworkPolicysIngressDenyFromCidrSet {
    ...
    pub cidr_group_selector:
        Option<CiliumClusterwideNetworkPolicysIngressDenyFromCidrSetCidrGroupSelector>,
    /// ExceptCIDRs is a list of IP blocks which the endpoint subject to the rule
    /// is not allowed to initiate connections to. These CIDR prefixes should be
    /// contained within Cidr, using ExceptCIDRs together with CIDRGroupRef is not
    /// supported yet.
...
pub struct CiliumClusterwideNetworkPolicysIngressDenyFromCidrSetCidrGroupSelector {
    ...
    pub match_expressions: Option<
        Vec<CiliumClusterwideNetworkPolicysIngressDenyFromCidrSetCidrGroupSelectorMatchExpressions>,
    >,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
