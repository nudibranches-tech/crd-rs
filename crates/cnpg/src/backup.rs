...
// kopium command: kopium -f /home/mmoreiradj/git/crd-rs/crds/cnpg/postgresql.cnpg.io_backups.yaml --schema=derived -d --hide-prelude
...
pub struct BackupStatus {
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "reconciliationStartedAt"
    )]
    ...
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "reconciliationTerminatedAt"
    )]
